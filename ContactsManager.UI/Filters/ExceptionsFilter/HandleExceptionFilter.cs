...
namespace CRUDE.Filters.ExceptionsFilter
{
    public class HandleExceptionFilter : IExceptionFilter
    {
        ...
        public void OnException(ExceptionContext context)
        {
           ...
           if(_hostEnvironment.IsDevelopment())  // if we dont want to reveal exact exception error for prodcion level we can use this if not it will show exception for user aswell
            {
